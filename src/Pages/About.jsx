            ...
            <div className={"flex flex-col items-center justify-center min-h-dvh px-12 lg:px-24 pt-30 md:pt-12"} id={props.name}>
                ...
                <p className={"mt-4 flex flex-col gap-6"}>
                    <p>
                        ...
                        etkinliğini organize etmiştir. 2025 yılında yedinci kez
                    ...
                    <p>
                        ...
                        Üniversitesi'nin önde gelen 5 büyük öğrenci topluluğu (Girişim ve Yatıcım Öğrenci Topluluğu, Hacettepe Ekonomi Topluluğu, Hacettepe Endüstri ve Sistem Topluluğu,
                        Hacettepe Kültür Sanat Topluluğu, Hacettepe Çeviri Topluluğu ve Hacettepe P&A Öğrenci Topluluğu) ile
